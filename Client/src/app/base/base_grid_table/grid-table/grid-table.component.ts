...
import { CustomColDef, GridParams } from '../models/base.model';
...
export class GridTableComponent implements OnInit {
  ...
  @Input() groupIncludeTotalFooter: any;
  @Input() groupIncludeFooter: any;
  @Input() suppressAggFuncInHeader: any;
